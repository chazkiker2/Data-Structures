...
class DoublyLinkedListTests(unittest.TestCase):
    ...
    def test_list_remove_from_tail(self):
        ...
        self.assertEqual(self.dll.head.key, 33)
        self.assertEqual(self.dll.tail.key, 33)
    ...
    def test_list_add_to_tail(self):
        ...
        self.assertEqual(self.dll.tail.key, 30)
        self.assertEqual(len(self.dll), 2)

        self.dll.add_to_tail(20)
        self.assertEqual(self.dll.tail.prev.key, 30)
        self.assertEqual(self.dll.tail.key, 20)
    ...
    def test_list_add_to_head(self):
        ...
        self.assertEqual(self.dll.head.key, 10)
    ...
    def test_list_move_to_end(self):
        ...
        self.assertEqual(self.dll.tail.key, 1)
        self.assertEqual(self.dll.head.key, 40)

        self.dll.move_to_end(self.dll.head)
        self.assertEqual(self.dll.tail.key, 40)
        self.assertEqual(self.dll.tail.prev.key, 1)
        self.assertEqual(len(self.dll), 2)
        ...
        self.assertEqual(self.dll.tail.key, 40)
        self.assertEqual(self.dll.tail.prev.key, 4)
        self.assertEqual(len(self.dll), 3)
    ...
    def test_list_move_to_front(self):
        ...
        self.assertEqual(self.dll.head.key, 3)
        self.assertEqual(self.dll.head.next.key, 1)
        self.assertEqual(len(self.dll), 2)
        ...
        self.assertEqual(self.dll.head.key, 3)
        self.assertEqual(self.dll.head.next.key, 29)
        self.assertEqual(len(self.dll), 3)
    ...
    def test_list_delete(self):
        ...
        self.assertEqual(self.dll.head.key, 9)
